...
class ControllerCatalogCustomerSupportCategory extends Controller { 
	...
	private function getList() {
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=catalog/customer_support_category&token=' . $this->session->data['token'],
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
									
		$this->data['customer_support'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support&token=' . $this->session->data['token'];
		$this->data['insert'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support_category/insert&token=' . $this->session->data['token'];
		$this->data['delete'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support_category/delete&token=' . $this->session->data['token'];
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => HTTPS_SERVER . 'index.php?route=catalog/customer_support_category/update&token=' . $this->session->data['token'] . '&category_id=' . $result['category_id']
			);
	...
	private function getForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support_category/insert&token=' . $this->session->data['token'];
		} else {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support_category/update&token=' . $this->session->data['token'] . '&category_id=' . $this->request->get['category_id'];
		}
		
		$this->data['cancel'] = HTTPS_SERVER . 'index.php?route=catalog/customer_support_category&token=' . $this->session->data['token'];
