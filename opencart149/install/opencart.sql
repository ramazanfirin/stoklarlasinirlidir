...
(4, 1, 'Coupon (-10%)', '10% İndirim'),
(5, 1, 'Coupon (Ücretsiz Kargo)', 'Ücretsiz Kargo'),
(6, 1, 'Coupon (-10.00)', 'Sabit Fiyat');
...
(1, 'Türk Lirası', 'TRY', '', 'TL', '2', 1.00000000, 1, '2010-04-06 22:00:54'),
...
(3, 'Tüm Türkiye', 'Tüm Türkiye dahil', '2010-02-26 22:33:24', '2009-01-06 23:26:25'),
...
(5, 1, 'Satış Sözleşmesi', 'OpenCart Yönetim panelinden Katalog/Bilgi Sayfaları bölümünden düzenleyebilirsiniz.'),
(3, 1, 'Gizlilik İlkeleri', 'OpenCart Yönetim panelinden Katalog/Bilgi Sayfaları bölümünden düzenleyebilirsiniz.'),
(4, 1, 'Hakkımızda', 'OpenCart Yönetim panelinden Katalog/Bilgi Sayfaları bölümünden düzenleyebilirsiniz.');
...
(58, 42, 0, 'eka7a', 'test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test ', 3, 1, '2010-01-02 03:14:24', '0000-00-00 00:00:00'),
(59, 42, 0, 'eka7a', 'test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test ', 2, 1, '2010-02-26 22:06:32', '0000-00-00 00:00:00'),
(60, 47, 0, 'eka7a', 'test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test', 3, 1, '2010-03-05 21:10:52', '0000-00-00 00:00:00');
...
(NULL, 'config', 'config_currency', 'TRY'),
(NULL, 'config', 'config_currency_auto', '1'),
(NULL, 'config', 'config_admin_language', 'tr'),
(NULL, 'config', 'config_zone_id', '3315'),
(NULL, 'config', 'config_language', 'tr'),
(NULL, 'config', 'config_country_id', '215'),
(NULL, 'config', 'config_description_1', '&lt;p&gt;\r\n	OpenCart Türkiye - OpenCart Türkçe Demo&lt;/p&gt;\r\n'),
(NULL, 'config', 'config_template', 'default'),
(NULL, 'config', 'config_meta_description', 'OpenCart Türkiye - OpenCart Türkçe Demo'),
(NULL, 'config', 'config_title', 'OpenCart Türkiye'),
(NULL, 'config', 'config_fax', ''),
(NULL, 'config', 'config_telephone', '123456789'),
(NULL, 'config', 'config_owner', 'OpenCart Türkiye'),
(NULL, 'config', 'config_address', 'Address 1'),
(NULL, 'config', 'config_email', 'webmaster@opencart-tr.com'),
(NULL, 'config', 'config_url', 'http://localhost/v1494/'),
(NULL, 'config', 'config_name', 'OpenCart Türkiye'),
(NULL, 'config', 'config_smtp_port', '587'),
...
(NULL, 'config', 'config_invoice_prefix', 'FA-2011-00'),
...
(9, 'KDV', 'Katma Değer Vergisi', '2009-01-06 23:21:53', '2010-02-26 22:08:04');
...
(82, 3, 9, 1, '18.0000', 'KDV 18%', '0000-00-00 00:00:00', '2010-02-26 22:08:04');
