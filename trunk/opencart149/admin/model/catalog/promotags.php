...
class ModelCatalogPromoTags extends Model {
	...
	public function getTotalProductsByPromoTagsId($promotags_id) {
      	$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product WHERE promo_banner = '" . (int)$promotags_id . "'");
