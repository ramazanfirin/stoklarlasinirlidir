...
class API
{
    ...
    "<CC5Request>\r\n".
                ...
                "<Number>{$DataArray['cc_no']}</Number>\r\n".
                "<Expires>{$DataArray['cc_month']}/{$DataArray['cc_year']}</Expires>\r\n".
                "<Cvv2Val>{$DataArray['cc_ccv']}</Cvv2Val>\r\n".
